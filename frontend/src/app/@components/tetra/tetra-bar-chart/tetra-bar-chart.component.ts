...
export class TetraBarChartComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.themeSubscription = this.theme.getJsTheme().subscribe(config => {
      ...
      this.warning = NbColorHelper.hexToRgbA(this.colors.warning, 0.8)
      this.danger = NbColorHelper.hexToRgbA(this.colors.danger, 0.8)
      this.success = NbColorHelper.hexToRgbA(this.colors.success, 0.8)
