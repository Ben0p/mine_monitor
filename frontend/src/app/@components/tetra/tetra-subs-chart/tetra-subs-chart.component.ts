...
@Component({
  selector: 'ngx-tetra-subs-chart',
  templateUrl: './tetra-subs-chart.component.html',
  styleUrls: ['./tetra-subs-chart.component.scss'],
})
export class TetraSubsChartComponent implements OnInit, OnDestroy {
  @Input() title: string;
  ...
  refreshData() {
    this.tetra.getTetraNodeSubscribers().subscribe(
      (loads: {}) => {
        this.loads = loads;
        this.loadData()
      }
